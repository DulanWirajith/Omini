...
//    List<OrderDetail> getItemOrderDetails(BusinessProfileCategoryPK businessProfileCategoryPK, String status);
    ...
    @Modifying
    @Transactional
    @Query(value = "delete from OrderDetail where itemOrder.orderId=?1 and businessProfileCategory.businessProfileCategoryId=?2")
    void removeCartShop(String orderId, BusinessProfileCategoryPK businessProfileCategoryPK);
