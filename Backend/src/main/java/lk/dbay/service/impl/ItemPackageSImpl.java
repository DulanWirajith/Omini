...
public class ItemPackageSImpl implements ItemPackageS {
    ...
    @Override
    public ItemPackageDTO getItemsPackagesBySearch(String txt, String category, String district, String town, String customerId, double lat, double lon) {
        ...
        setItemPackageDTO(itemsBySearch, items, customerId, lat, lon);
        setItemPackageDTO(packagesBySearch, itemPackages, customerId, lat, lon);
