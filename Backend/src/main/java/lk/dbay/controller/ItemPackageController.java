...
//
    ...
    @GetMapping(value = "/getItemsPackagesBySearch/{txt}/{category}/{district}/{town}/{customerId}/{lat}/{lon}")
    public ResponseEntity getItemsPackagesBySearch(@PathVariable String txt, @PathVariable String category, @PathVariable String district, @PathVariable String town, @PathVariable String customerId, @PathVariable double lat, @PathVariable double lon) {
        return ResponseEntity.ok(itemPackageS.getItemsPackagesBySearch(txt, category, district, town, customerId, lat, lon));
    }
